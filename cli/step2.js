...
module.exports = function step2() {
    ...
    Документируйте код используюя JSDoc и проверяйте код при помощи ${chalk.blue('eslint')} 
    ...
    Конечным резульатом должен быть работающий веб-сервер и успешно пройденные модульные тесты и проверки eslint
